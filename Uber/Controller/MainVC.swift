...
class MainVC: UIViewController {
    ...
    var currentLocationAddressName = String()
...
extension MainVC: CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    func mapRoute() {
        ...
        directions.calculate { (response, error) in
            ...
            //in seconds, so divide by 60
            self.routeETA = route.expectedTravelTime / 60
    ...
    func locationManager(_ manager: CLLocationManager,
        ...
        // we have to multiply the regionradius by 2.0 because it's only one direction but we want 1000 meters in both directions;we're gonna set how wide we want the radius to be around the center location
    ...
    func convertCoordinates() {
        ...
        //convert coordinates into friendly names
